            ...
            const { instruments, confidence: conf } = detectInstrumentsWithGenre(
                {
                    ...
                    energy: (metadata as any).energyLevel || (metadata as any).energy_level || 'Medium',
                    stereoWidth: audioFeatures.stereo?.width ?? 0.5,
                    loudness: audioFeatures.loudnessDb ?? -14,
                    ...
                    stereoCorrelation: audioFeatures.stereo?.correlation ?? 0.5,
                },
                metadata.mainGenre
            );
        ...
        <Card className="border-l-4 border-l-cyan-500">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    {audioFeatures.dynamicRange != null && (
                        <div className="p-3 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-100 dark:border-slate-800">
                            <div className="text-[9px] font-bold text-slate-400 uppercase mb-1">Dynamic Range (LRA)</div>
                            <div className="text-sm font-mono font-bold text-slate-800 dark:text-slate-200">{audioFeatures.dynamicRange} dB</div>
                        </div>
                    )}
                    {audioFeatures.spectralCentroid != null && (
                        <div className="p-3 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-100 dark:border-slate-800">
                    ...
                    {audioFeatures.energy && (
                        <div className="p-3 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-100 dark:border-slate-800">
                            <div className="text-[9px] font-bold text-slate-400 uppercase mb-1">Energy Level</div>
                            <div className="text-sm font-mono font-bold text-slate-800 dark:text-slate-200">{audioFeatures.energy}</div>
                        </div>
                    )}
                    {audioFeatures.tempoCharacter && (
                        <div className="p-3 col-span-2 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-100 dark:border-slate-800">
                            <div className="text-[9px] font-bold text-slate-400 uppercase mb-1">Tempo Character</div>
                            <div className="text-sm font-mono font-bold text-slate-800 dark:text-slate-200">{audioFeatures.tempoCharacter}</div>
                        </div>
                    )}
                </div>
            </div>
