            ...
            <div className="space-y-6">
                ...
                <div className="group pt-4 border-t border-slate-100 dark:border-slate-800">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <Tooltip text="Suggest similar artists (AI)">
                            <button
                                onClick={() => onRefine('similar_artists' as keyof Metadata)}
                                className="text-slate-400 hover:text-accent-violet transition-colors disabled:opacity-50"
                                disabled={!!refiningField}
                            >
                                {refiningField === ('similar_artists' as keyof Metadata) ? (
                                    <div className="w-3 h-3 border-2 border-accent-violet border-t-transparent rounded-full animate-spin" />
                                ) : (
                                    <Sparkles className="w-3 h-3 text-accent-violet" />
                                )}
                            </button>
