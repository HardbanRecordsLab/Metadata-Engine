...
export interface Metadata {
    ...
    license?: string; // e.g. CC BY-NC, All Rights Reserved
    ...
    // DSP-derived analysis fields
    dynamicRange?: number;      // dB LRA
    spectralCentroid?: number;  // Hz
    spectralRolloff?: number;   // Hz
    acousticScore?: number;     // 0-100 (0=fully electronic, 100=fully acoustic)
    hasVocals?: boolean;        // Detected vocal presence
    ...
    // LLM Ensemble confidence (0.0–1.0), populated from backend _tech_meta
    confidence?: number;
}
